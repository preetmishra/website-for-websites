"""
Django settings for websiteforwebsites project.
...
ALLOWED_HOSTS = [
    'awebsiteforwebsites.herokuapp.com',
]
...
ROOT_URLCONF = 'websiteforwebsites.urls'
...
WSGI_APPLICATION = 'websiteforwebsites.wsgi.application'
